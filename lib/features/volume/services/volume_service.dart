...
class VolumeService {
  ...
  Future<void> setVolume(double volume, {VolumeStream stream = VolumeStream.media}) async {
  ...
  Future<bool> isDndEnabled() async {
    ...
    return filter != InterruptionFilter.all && filter != InterruptionFilter.unknown;
  }
